        ...
        <div class="row display-flex">
            ...
            <div class="col col-xl-5 col-lg-6 col-md-12 col-sm-12 col-12">
                ...
                <div class="registration-login-form">
                    ...
                    <div class="title h6">رمز عبور جدید</div>
                        ...
                        <div class="row">
                            <div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group label-floating is-empty">
                                    <label class="control-label">رمز یک بار مصرف</label>
                                    <input class="form-control" placeholder="" type="text" name="disposablePassword" value="{{ old('disposablePassword') }}" required autofocus>
                                </div>
                                <div class="form-group label-floating is-empty">
