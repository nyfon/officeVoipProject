                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="databox radius-bordered bg-white">
                                <div class="databox-right no-padding">
                                    <img src="/adminAssets/img/avatars/John-Smith.jpg" style="width:65px; height:65px;">
                                </div>
                                    ...
                                    <div class="tickets-container">
                                        <ul class="tickets-list">
                                            <li class="ticket-item">
                                                <div class="row">
                                                    <div class="ticket-user col-lg-6 col-sm-12">
                                                        <img src="/adminAssets/img/avatars/adam-jansen.jpg" class="user-avatar">
                                            ...
                                            <li class="ticket-item">
                                                <div class="row">
                                                    <div class="ticket-user col-lg-6 col-sm-12">
                                                        <img src="/adminAssets/img/avatars/divyia.jpg" class="user-avatar">
                                            ...
                                            <li class="ticket-item">
                                                <div class="row">
                                                    <div class="ticket-user col-lg-6 col-sm-12">
                                                        <img src="/adminAssets/img/avatars/Matt-Cheuvront.jpg" class="user-avatar">
                                            ...
                                            <li class="ticket-item">
                                                <div class="row">
                                                    <div class="ticket-user col-lg-6 col-sm-12">
                                                        <img src="/adminAssets/img/avatars/Sergey-Azovskiy.jpg" class="user-avatar">
                                            ...
                                            <li class="ticket-item">
                                                <div class="row">
                                                    <div class="ticket-user col-lg-6 col-sm-12">
                                                        <img src="/adminAssets/img/avatars/John-Smith.jpg" class="user-avatar">
                        ...
                        <div class="databox-top bg-whitesmoke no-padding">
                            <div class="databox-row row-2 bg-orange no-padding">
                                ...
                                <div class="databox-cell cell-8 no-padding padding-top-5 text-align-left">
                                    <span class="databox-number white">بازدید صفحات</span>
                                </div>
