                ...
                <div class="col-xs-12 col-md-12">
                    <div class="widget">
                        <div class="widget-header ">
                            <span class="widget-caption">بیماران</span>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="expandabledatatable">
                                ...
                                @foreach($users as $key => $user)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a href="{{ route('admin.patient.changeStatus',['user'=> $user, 'status'=>'onactive' ]) }}">غیر
                                                            فعال</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.patient.changeStatus',['user'=> $user, 'status'=>'active' ]) }}">فعال</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('admin.patient.changeStatus',['user'=> $user, 'status'=>'lock' ]) }}">قفل</a>
                                                    </li>
                                        ...
                                        <td>
                                            <form action="{{ route('admin.patient.destroy'  , ['user' => $user]) }}" method="post">
                                                {{ method_field('delete') }}
                                                {{ csrf_field() }}
                                                <button type="submit" class="btn btn-danger">پاک کردن</button>
                                                <a href="{{ route('admin.patient.show' , ['user' => $user]) }}" class="btn btn-primary">نمایش</a>
                                            </form>
                                        </td>
