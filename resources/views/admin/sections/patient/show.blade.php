    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('admin.patient.index') }}">بیماران</a>
                </li>
                    ...
                    <div class="profile-container">
                        <div class="profile-header row">
                            <div class="col-lg-2 col-md-4 col-sm-12 text-center">
                                <img src="/adminAssets/img/avatars/user.png" alt="" class="header-avatar"/>
                            </div>
                            <div class="col-lg-5 col-md-8 col-sm-12 profile-info">
                                <div class="header-fullname">{{ $user->generalPatient->fullname() }}</div>
                                ...
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content tabs-flat">
                                        ...
                                        <div id="settings" class="tab-pane">
                                            <form  action="{{ route('admin.patient.update',$user) }}" method="post"
                                                ...
                                                <span class="input-icon icon-right">
                                                    <input type="text" class="form-control"
                                                           name="name" value="{{ old('name' , $user->generalPatient->name) }}"
                                                ...
                                                <span class="input-icon icon-right">
                                                    <input type="text" class="form-control"
                                                           name="family" value="{{ old('family', $user->generalPatient->family) }}"
                                                ...
                                                <span class="input-icon icon-right">
                                                      <textarea class="form-control" id="textareaanimated"
                                                                ...
                                                                placeholder="ادرس 1"
                                                                rows="5">{{ $user->generalPatient->address1 }}</textarea>
                                                     <i class="glyphicon glyphicon-font"></i>
                                                </span>
                                                ...
                                                <span class="input-icon icon-right">
                                                      <textarea class="form-control" id="textareaanimated"
                                                                ...
                                                                placeholder="ادرس 1"
                                                                rows="5">{{ $user->generalPatient->address2 }}</textarea>
                                                     <i class="glyphicon glyphicon-font"></i>
                                                </span>
