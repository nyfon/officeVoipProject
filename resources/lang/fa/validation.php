...
return array(
    ...
    */
    ...
    'iranian_national_code' => 'کد ملی درست وارد نشده است .',
    ...
    */
    'attributes' => array(
        ...
        'dentistNumber' => 'شماره نظام پزشکی',
        'dateBirth' => 'تاریخ تولد',
        'reagentCode'=>'کد معرف',
        'officeNumber'=>'شماره محل کار',
        'profilePicture'=>'عکس پروفایل',
        'officeAddress'=>'ادرس محل کار',
        'titleBrand'=>'نام شرکت',
        'tel'=>'شماره تلفن شرکت',
        ...
        'site'=>'لینک وبسایت',
        'userCode'=>'کد کاربری',
        'numberActive'=>'کد ورود',
        'points'=>'امتیاز',
        'pic'=>'عکس',
        'pic.*'=>'فیلد اسلایدر',
        'banner_photo' => 'عکس بنر',
        'video'=>'فیلم',
        'amount'=>'قیمت',
